...
const recipe = {
  ...
  steps: [
    ...
    'For chicken wings (see https://www.google.com), heat canola oil to 350 F. Cover a baking tray with paper towels to catch oil. When oil is hot, add a few chicken wings and cook 4 minutes per side (if the wings are larger, cooking time may be longer) or until 165 F internal temp.  Add chicken wings to baking sheet to cool.',
